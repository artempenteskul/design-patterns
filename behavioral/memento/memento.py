...
class Originator:
    ...
    It also defines a method for saving the state inside a memento and another method for restoring state from it.
    """
    _state = None
    ...
    def do_something(self) -> None:
        ...
        Therefore, client should backup the state before launching methods of the business logic via the save() method.
        """
...
class Memento(ABC):
    ...
    However, it does not expose the Originator's state.
    """
    @abstractmethod
...
class Caretaker:
    ...
    Therefore, it does not have access to the originator's state, stored inside the memento.
    ...
    def backup(self) -> None:
        print('Caretaker: Saving Originator state.')
