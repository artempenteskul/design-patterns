...
class State(ABC):
    """
    The base State class declares methods that all Concrete State should implement and also provides a back reference to
    the Context object, associated with the State. The back reference can be used by States to transition the
    Context ot another State.
    """
