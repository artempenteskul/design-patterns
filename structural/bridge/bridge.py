...
class Implementation(ABC):
    """
    The Implementation defines the interface for all implementation classes. It doesn't have to match the Abstraction's interface.
    In fact, the two interfaces can be entirely different. Typically the Implementation interface provides only primitive operations, 
...
def client_code(abstraction: Abstraction) -> None:
    ...
    the client code could only depend on the Abstraction class. This way client code can support any abstraction-implementation combination.
    """ 
