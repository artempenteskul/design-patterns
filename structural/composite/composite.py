...
class Component(ABC):
    ...
    def operation(self) -> str:
        """
        The Base Component may implement some default behaviour or leave it to concrete classes
        """
        pass
...
class Leaf(Component):
    ...
    Usually, it's the Leaf objects that do the actural work, whereas Composite objects only delegate to their sub-components.
    """
    def operation(self) -> str:
        return 'Leaf'
...
def client_code(component: Component) -> None:
    """
    The clients code works with all of the components via the base interface.
    """
...
def client_code_2(component1: Component, component2: Component) -> None:
    """
    Thanks to the fact that the child-management operation are declared in the base Component class, the client code can work with any component,
